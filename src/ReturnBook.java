...
public class ReturnBook extends JFrame {
	...
	public ReturnBook() {
		...
		fine.setFont(new Font("Tahoma", Font.PLAIN, 13));
		
		JLabel fineValue=new JLabel();
		...
		btnReturnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				fineValue.setText(String.valueOf(ReturnBookDao.findValue(bookcallno, studentid))+"rupees");
